...
def rand7():
    ...
    while rand_draw > 21:
        ...
        # Average number of loop iterations = Σ(4/25)^k for integers k from 0 to ∞, which is approximately 1.1905.
        # This means the average number of calls to rand5() is 2.3810.
